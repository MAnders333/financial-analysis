...
class FinancialAnalyzer:
    ...
    def update_workbook(self, cash=0.0):
        ...
        current_values = [current_year, self.current_month, self.cash, cashflow, bank_balance, bank_cashflow, investments, investments_change, assets_total, assets_total_change, assets_rel_change]
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        cash = sys.argv[1] # Specify your current cash balance in the terminal as an argument
    else:
        cash = 0.0
